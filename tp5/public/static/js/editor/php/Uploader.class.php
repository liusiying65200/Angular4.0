...
class Uploader
{
    ...
    private function getFilePath()
    {
        ...
        $rootPath = str_replace('/admin/static/js/editor/php','',dirname(realpath($_SERVER['SCRIPT_FILENAME'])));
