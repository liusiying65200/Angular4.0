...
var $type=$('#type').val();
var $mess=$('#mess');
$.post('/lh3/index.php/Home/Kaijiang/clear',{type:$type},function(data){
alert("缓存清理成功");
});
}else{
return false;
...
<form action="/lh3/index.php/Home/Kaijiang/" method="get">

<input type="button" value="开奖添加" onclick="location.href='/lh3/index.php/Home/Kaijiang/info_add.html'"  class="btn btn-xs btn-danger" />
...
<td align="center">
<a href="/lh3/index.php/Home/Kaijiang/info_edit/Id/<?php echo ($vo["id"]); ?>">更新开奖</a> 
...
jQuery.ajax({
url: "/lh3/index.php/Home/Kaijiang/infodelete.html",
dataType:"json",
type:"POST",
...
$("#msg").html(data.msg)
intervalid =setInterval("TiaoSecond('/lh3/index.php/Home/Kaijiang/index.html')",1000);//==========执行几秒跳转
}
});
}  
}
