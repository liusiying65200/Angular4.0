							...
							<div class="col-xs-12">
								...
								<input id="ClassID"  type="hidden" value="">
                                	<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 采集项目名称： </label>
										<div class="col-sm-9">
											<input type="text" name="biaoti" id="biaoti" class="col-xs-10 col-sm-5" placeholder="请输入采集项目名称" />
											<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>采集项目名称，中文</span>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 采集编码： </label>
										<div class="col-sm-9">
											<select id="bianma" name="bianma" class="col-sm-4">
											<option>UTF-8</option>
											<option>GB2312</option>
											</select>
											<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>抓取页面编码</span>
                                            <span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<iframe frameborder=0 id=FrmRight name=right src="/lh3/index.php/Home/Caiji/directory/?NumberID=<?php echo ($_SESSION['article_class']); ?>" style="HEIGHT:28px;Z-INDEX: 1"></iframe>
											<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>文章所属分类</span>
                                            <span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 采集页面路径： </label>
										<div class="col-sm-9">
											<input type="text" name="url" id="url" placeholder="请输入采集页面路径"  class="col-xs-10 col-sm-5" />
											<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>采集页面路径</span>
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="resthr"></span>
											</span>
										</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 采集节点范围： </label>
										<div class="col-sm-9">
											<input type="text" name="fanwei" id="fanwei" placeholder="请输入采集节点范围规则"   class="col-xs-10 col-sm-5" />
											<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>采集列表节点范围标记(jquery 语法) 如：<code>.test li</code></span>
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="resthr"></span>
											</span>
										</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 列表地址： </label>
										<div class="col-sm-9">
											<input type="text" name="cjurl" id="cjurl" placeholder="列表地址规则"  class="col-xs-10 col-sm-5" />
											<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>地址节点标记(jquery 语法) 如：<code>li a:eq(0) </code></span>
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="resthr"></span>
											</span>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="title" id="title" placeholder="请输入标题规则" class="col-xs-10 col-sm-5" />
											<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>地址节点标记(jquery 语法) 如：<code>li a:eq(0) </code></span>
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="resthr"></span>
											</span>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 采集缩略图： </label>
										<div class="col-sm-9">
											<input type="text" name="picurl" id="picurl" placeholder="请输入采集缩略图规则" class="col-xs-10 col-sm-5" />
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="resthr"></span>
											</span>
										</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 过滤内容规则： </label>
										<div class="col-sm-9">
											<input type="text" name="glzd" id="glzd" placeholder="请输入过滤内容规则" class="col-xs-10 col-sm-5" />
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="resthr"></span>
											</span>
										</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 过滤标题规则： </label>
										<div class="col-sm-9">
											<input type="text" name="glbt" id="glbt" placeholder="请输入过滤标题规则" class="col-xs-10 col-sm-5" />
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="resthr"></span>
											</span>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="cjmc" id="cjmc" placeholder="发布文章时的作者" class="col-xs-10 col-sm-5" />
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="resthr"></span>
											</span>
										</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 内容范围： </label>
										<div class="col-sm-9">
											<input type="text" name="nrfw" id="nrfw" placeholder="请输入内容范围规则" class="col-xs-10 col-sm-5" />
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="resthr"></span>
											</span>
										</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 页面内容规则： </label>
										<div class="col-sm-9">
											<input type="text" name="nrgz" id="nrgz" placeholder="请输入页面内容规则" class="col-xs-10 col-sm-5" />
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="resthr"></span>
											</span>
										</div>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<input type="submit"  value="提 交" class="btn btn-info"  onClick="Get_add_Save()"/>
											&nbsp; &nbsp; &nbsp;
...
var cjmc  =$("#cjmc").attr("value");
var cjurl =$("#cjurl").attr("value");
var glzd  =$("#glzd").attr("value");
var glbt  =$("#glbt").attr("value");
var nrgz  =$("#nrgz").attr("value");
var nrfw  =$("#nrfw").attr("value");
var picurl=$("#picurl").attr("value");
var fanwei=$("#fanwei").attr("value");
var bianma=$("#bianma").attr("value");
var ClassID =$("#ClassID").attr("value");
jQuery.ajax({
url: "/lh3/index.php/Home/Caiji/info_add.html",
dataType:"json",
type:"POST",
data:{Action:"Add",title:title,url:url,biaoti:biaoti,cjmc:cjmc,ClassID:ClassID,cjurl:cjurl,glzd:glzd,glbt:glbt,nrgz:nrgz,nrfw:nrfw,picurl:picurl,fanwei:fanwei,bianma:bianma},
beforeSend: function(XHR){
$('#msg').html('<center><br><br><img alt="正在加载中..." src="<?php echo (IMG_URL); ?>Loading/load1.gif" ></center>');	
},
success:function(data) {
$("#msg").html(data.msg)
intervalid =setInterval("TiaoSecond('/lh3/index.php/Home/Caiji/info_add.html')",1000);//==========执行几秒跳转
}
});
