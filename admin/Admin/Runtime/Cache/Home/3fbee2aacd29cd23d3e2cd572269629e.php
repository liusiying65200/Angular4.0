...
var $type=$('#type').val();
var $mess=$('#mess');
$.post('/lh3/index.php/Home/Notice/clear',{type:$type},function(data){
alert("缓存清理成功");
});
}else{
return false;
			...
			<div class="page-content">
				...
				<div class="row maintop">
					<div class="col-xs-12 col-sm-8">
						...
						<form action="/lh3/index.php/Home/Notice/" method="get">

							<input type="button" value="添加公告" onclick="location.href='/lh3/index.php/Home/Notice/add'"  class="btn btn-xs btn-danger" />
				...
				<form class="form-search form-horizontal" action="/lh3/index.php/Home/Notice/" method="get">
					<div class="row maintop">
						...
						<div class="input-group-btn">
							<a href="/lh3/index.php/Home/Notice/index.html">
									...
									<div class="table-responsive">
										<table width="100%" class="table table-striped table-bordered table-hover">
											...
											<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr bgcolor="ffffff" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#F5F5F5'">
													...
													<td align="center"><?php if($vo["type"] == 1): ?>流动型公告<?php else: ?>固定型公告<?php endif; ?></td>
													<td align="center">
														<a href="/lh3/index.php/Home/Notice/edit?id=<?php echo ($vo["id"]); ?>">修改</a>
...
<script src="/lh3/Public/js/jquery.min.js"></script>
<script>
    ...
    function del(){
        ...
        if(confirm('您确定要删除此数据？')){
            ...
            ids=dropIds.join(',');
            $.ajax({
                url: "/lh3/index.php/Home/Notice/del",
                dataType:"json",
                type:"POST",
                data:{id:ids},
                success:function(data){
                  if(data.status==1){
                      layer.msg(data.info);
                      location.href='/lh3/index.php/Home/Notice';
				  }else{
                      layer.msg(data.info);
				  }
                }
