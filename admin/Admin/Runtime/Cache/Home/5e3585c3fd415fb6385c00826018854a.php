...
<div class="formbody">										
<div id="msg">
<input id="Id" type="hidden" value="<?php echo ($info["id"]); ?>">
<input id="ClassID"  type="hidden" value="">
<table class="page_table" cellpadding="0" cellspacing="1">
<tr>
<td width="10%" class="td_left">信息标题：</td>
<td width="90%" class="left"><input id="title" type="text" style="width:350px;" class="biankuan" value="<?php echo ($info["title"]); ?>"/></td>
</tr>
<tr>
<td width="9%"  class="td_left">信息分类：</td>
<td colspan="2" class="left"><iframe frameborder=0 id=FrmRight name=right src="/lh3/index.php/Home/Article/directory/?NumberID=<?php echo ($info['directory4']); ?>" style="HEIGHT:30px; VISIBILITY: inherit; WIDTH: 100%; Z-INDEX: 1"></iframe></td>
</tr>
<tr>
<td width="9%" class="td_left">内容描述：</td>

<td colspan="2" class="left"><textarea id="editor_id" name="content" style="width:700px;height:300px;"><?php echo ($info["content"]); ?></textarea></td>
...
jQuery.ajax({
url: "/lh3/index.php/Home/Article/info_edit.html",
dataType:"json",
type:"POST",
