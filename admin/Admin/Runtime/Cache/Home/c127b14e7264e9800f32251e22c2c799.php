...
<input type="button" value="添加网址" onclick="location.href='/lh3/index.php/Home/Links/info_add.html'"  class="btn btn-xs btn-danger" />
...
<form class="form-search form-horizontal" action="/lh3/index.php/Home/Links/" method="get">
							<div class="row maintop">	
							<div class="col-xs-12 col-sm-3 btn-sespan">
							  ...
							  <div class="input-group-btn">
								<a href="/lh3/index.php/Home/Links/index.html">
...
<td align="center"><?php echo (czdirectory('links_url','0',$vo["directory4"])); ?> </td>
<td align="center"><?php echo (datetime($vo["begtime"])); ?> </td>
<td align="center">
<a href="/lh3/index.php/Home/Links/info_edit/Id/<?php echo ($vo["id"]); ?>">修改</a> 
...
jQuery.ajax({
url: "/lh3/index.php/Home/Links/RightSave.html",
dataType:"json",
type:"POST",
...
$("#msg").html(data.msg)
intervalid =setInterval("TiaoSecond('/lh3/index.php/Home/Links/index.html')",1000);//==========执行几秒跳转
}
});
}
...
jQuery.ajax({
url: "/lh3/index.php/Home/Links/infodelete.html",
dataType:"json",
type:"POST",
