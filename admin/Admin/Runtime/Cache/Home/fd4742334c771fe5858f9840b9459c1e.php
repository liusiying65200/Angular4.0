...
<tr>
<td width="10%" class="td_left">第多少期：</td>
<td width="90%" class="left"><input id="title" type="text" style="width:350px;" class="biankuan" placeholder="请输入现在期数"/></td>
</tr>
<tr>
<td width="9%"  class="td_left">信息分类：</td>
<td colspan="2" class="left">
<iframe frameborder=0 id=FrmRight name=right src="/lh3/index.php/Home/Tuku/qs_directory/?NumberID=<?php echo ($_SESSION['qs_class']); ?>" style="HEIGHT:30px; VISIBILITY: inherit; WIDTH: 100%; Z-INDEX: 1"></iframe></td>
</tr>
<tr>
<td>
</td>
...
jQuery.ajax({
url: "/lh3/index.php/Tuku/qs_info_add",
dataType:"json",
type:"POST",
data:{Action:"Add",title:title,ClassID:ClassID,path:path},
beforeSend: function(XHR){
$('#msg').html('<center><br><br><img alt="正在加载中..." src="<?php echo (IMG_URL); ?>Loading/load1.gif" ></center>');	
},
success:function(data) {
$("#msg").html(data.msg)
intervalid =setInterval("TiaoSecond('/lh3/index.php/Home/Tuku/qs_info_add.html')",1000);//==========执行几秒跳转
}
});
