	...
	function complete(data){
		if(data.status==1){
			...
			return false;	
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" name="config" id="config" method="post" action="<?php echo U('runsys');?>">
                                <input type="hidden" name="id" value="<?php echo ($config["id"]); ?>" />
                                	<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 站点名称 </label>
										<div class="col-sm-9">
											<input type="text" name="site_name" id="site_name" value="<?php echo ($config["site_name"]); ?>" class="col-xs-10 col-sm-5" />
											<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>不要超出20个字，否则错位。</span>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="site_url" id="site_url" value="<?php echo ($config["site_url"]); ?>"  class="col-xs-10 col-sm-5" />
											<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>必须加上http://  结尾要加上\ &nbsp; 如：http://www.cpbbs.cc/</span>
                                            <span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 手机版地址 </label>
										<div class="col-sm-9">
											<input type="text" name="site_wap" id="site_wap" value="<?php echo ($config["site_wap"]); ?>"  class="col-xs-10 col-sm-5" />
											<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>必须加上http://  结尾要加上\ &nbsp; 如：http://m.cpbbs.cc/</span>
                                            <span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="site_title" id="site_title" value="<?php echo ($config["site_title"]); ?>"  class="col-xs-10 col-sm-5" />
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="resthr"></span>
											</span>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
                                            <textarea  name="site_keywords" cols="20" class="col-xs-10 col-sm-7 limited"  id="form-field-9"  maxlength="100"><?php echo ($config["site_keywords"]); ?></textarea>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											 <textarea  name="site_describe" cols="20" class="col-xs-10 col-sm-7 limitedone"   id="form-field-10"  maxlength="200"><?php echo ($config["site_describe"]); ?></textarea>
