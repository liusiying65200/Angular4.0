...
var $type=$('#type').val();
var $mess=$('#mess');
$.post('/lh3/index.php/Home/Tuku/clear',{type:$type},function(data){
alert("缓存清理成功");
});
}else{
return false;
...
<form action="/lh3/index.php/Home/Tuku/" method="get">

<input type="button" value="黑白图库添加" onclick="location.href='/lh3/index.php/Home/Tuku/heibai_info_add.html'"  class="btn btn-xs btn-danger" />
...
<form class="form-search form-horizontal" action="/lh3/index.php/Home/Tuku/" method="get">
							<div class="row maintop">	
							<div class="col-xs-12 col-sm-3 btn-sespan">
							  ...
							  <div class="input-group-btn">
								<a href="/lh3/index.php/Home/Tuku/heibai.html">
...
<td align="center"><?php echo (czdirectory('heibai','0',$vo["directory4"])); ?> </td>
<td align="center"><?php echo ($vo["hits"]); ?></td>
<td align="center"><?php echo (datetime($vo["begtime"])); ?> </td>
<td align="center">
<a href="/lh3/index.php/Home/Tuku/heibai_info_edit/Id/<?php echo ($vo["id"]); ?>">修改</a> 
...
jQuery.ajax({
url: "/lh3/index.php/Home/Tuku/RightSave.html",
dataType:"json",
type:"POST",
...
$("#msg").html(data.msg)
intervalid =setInterval("TiaoSecond('/lh3/index.php/Home/Tuku/heibai.html')",1000);//==========执行几秒跳转
}
});
}
...
jQuery.ajax({
url: "/lh3/index.php/Home/Tuku/heibai_infodelete.html",
dataType:"json",
type:"POST",
