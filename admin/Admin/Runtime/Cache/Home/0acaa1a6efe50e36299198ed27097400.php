									...
									<form id="editForm">
										<table class="page_table" cellpadding="0" cellspacing="1">
											<tr>
												...
												<td width="90%" class="left"><input name="title" style="width:350px;" value='<?php echo ($row["title"]); ?>' class="biankuan" placeholder="请输入标题名称"/></td>
											</tr>

											<tr>
												<td width="10%" class="td_left">链接地址：</td>
												<td width="90%" class="left"><input  type="text" name="url" value='<?php echo ($row["url"]); ?>' class="biankuan" style="width:350px;"/></td>
											</tr>
											<tr>
												<td width="10%" class="td_left">公告类型：</td>
												<td width="90%" class="left">
													<select name="type" id="type">
														<option value=0>固定型公告</option>
														<option value=1>流动型公告</option>
													</select>
												</td>
											</tr>
