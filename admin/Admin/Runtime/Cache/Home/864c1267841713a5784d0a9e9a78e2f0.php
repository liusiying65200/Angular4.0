...
<input type="button" value="彩图图库添加" onclick="location.href='/lh3/index.php/Home/Tuku/caise_info_add.html'"  class="btn btn-xs btn-danger" />
...
<form class="form-search form-horizontal" action="/lh3/index.php/Home/Tuku/" method="get">
							...
							<div class="col-xs-12 col-sm-3 btn-sespan">
							  ...
							  <div class="input-group-btn">
								<a href="/lh3/index.php/Home/Tuku/caise.html">
...
<td align="center"><?php echo (czdirectory('tuku','0',$vo["directory4"])); ?> </td>
<td align="center"><?php echo ($vo["hits"]); ?></td>
<td align="center"><?php echo (datetime($vo["begtime"])); ?> </td>
<td align="center">
<a href="/lh3/index.php/Home/Tuku/caise_info_edit/Id/<?php echo ($vo["id"]); ?>">修改</a> 
...
$("#msg").html(data.msg)
intervalid =setInterval("TiaoSecond('/lh3/index.php/Home/Tuku/caise.html')",1000);//==========执行几秒跳转
}
});
}
...
jQuery.ajax({
url: "/lh3/index.php/Home/Tuku/caise_infodelete.html",
dataType:"json",
type:"POST",
