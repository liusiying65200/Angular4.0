...
td,th{padding:0;}
				...
				<div class="main-content-inner">
					<div class="page-content">
							...
							<div class="row maintop">
								...
								<a href="/lh3/index.php/Home/Sys/admin_list_add">
								...
								<form name="admin_list_sea" class="form-search" method="post" action="/lh3/index.php/Home/Sys/admin_list">
  ...
  <div class="input-group-btn">
  	<a href="/lh3/index.php/Home/Sys/admin_list">
...
function del(id){
	...
	layer.close(index);
	window.location.href="/lh3/index.php/Home/Sys/admin_list_del/admin_id/"+id+"";
	});
}
