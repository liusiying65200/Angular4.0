...
<div class="formbody">										
<div id="msg">
<input type="hidden" id="RootID" value="<?php echo ($RootID); ?>">
<input type="hidden" id="PartID" value="<?php echo ($PartID); ?>">
<input type="hidden" id="LagID"  value="<?php echo ($LagID); ?>"> 
<table cellspacing="1" cellpadding="0" class="page_table">
<tr>
<td width="7%" height="35" align="right" class="td_left">识别号：</td>
<td width="93%" align="left"><input id="NumberID" type="text" value="<?php echo ($JJ); ?>" class="biankuan"/>  </td>
</tr>
<tr>
...
<td align="left"><input type="text" id="sorting" value="<?php echo ($J); ?>" class="biankuan"  onKeyPress="return regInput(this,/^[0-9]*$/, String.fromCharCode(event.keyCode))"> </td>
</tr>
<tr>
...
jQuery.ajax({
url: "/lh3/index.php/Home/Article/index_class_add_save.html",
dataType:"json",
type:"POST",
...
$("#msg").html(data.msg)
intervalid =setInterval("TiaoSecond('/lh3/index.php/Home/Article/index_class_add.html?Id="+data.url+"')",1000);
}
});
