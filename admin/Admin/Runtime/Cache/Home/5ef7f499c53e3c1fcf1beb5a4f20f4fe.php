...
var $type=$('#type').val();
var $mess=$('#mess');
$.post('/lh3/index.php/Home/Links/clear',{type:$type},function(data){
alert("缓存清理成功");
});
}else{
return false;
...
<form action="/lh3/index.php/Home/Links/" method="get">

<input type="button" value="添加栏目" onclick="location.href='/lh3/index.php/Home/Links/index_class_add.html?Id=<?php echo ($NumberID); ?>'"  class="btn btn-xs btn-danger" />
							...
							<div class="row">
							    <div class="col-xs-12">
										<div>
<div class="formbody">
<form name="form1" method="post" action="/lh3/index.php/Home/Links/Action.html">
...
<div class="dirction">
<?php if($Startid==$vo['sorting']){ echo '<a class="move top1" href="javascript:void(0)" title="已经是第一条数据了"></a>'; }else{ echo '<a class="move top"  href="/lh3/index.php/Home/Links/class_sorting/Point/1/id/'.$vo[sorting].'/sid/'.$Startid.'/numberid/'.$NumberID.'" title="置顶"></a>'; } ?>
<?php if($Startid==$vo['sorting']){ echo '<a class="move up1" href="javascript:void(0)" title="已经是第一条数据了"></a>'; }else{ $uid=getsorting('cz_links_url_class','up',$vo[sorting],'1',$vo[lagid],$vo[numberid]); echo '<a class="move up"  href="/lh3/index.php/Home/Links/class_sorting/Point/2/id/'.$vo[sorting].'/sid/'.$uid.'/numberid/'.$NumberID.'" title="往上移动"></a>'; } ?>
<?php if($Endid==$vo['sorting']){ echo '<a class="move down1" href="javascript:void(0)" title="已经是最后条数据了"></a>'; }else{ $uid=getsorting('cz_links_url_class','down',$vo[sorting],'1',$vo[lagid],$vo[numberid]); echo '<a class="move down"  href="/lh3/index.php/Home/Links/class_sorting/Point/3/id/'.$vo[sorting].'/sid/'.$uid.'/numberid/'.$NumberID.'" title="往下移动"></a>'; } ?>
<?php if($Endid==$vo['sorting']){ echo '<a class="move bottom1" href="javascript:void(0)" title="已经是最后条数据了"></a>'; }else{ echo '<a class="move bottom"  href="/lh3/index.php/Home/Links/class_sorting/Point/4/id/'.$vo[sorting].'/sid/'.$Endid.'/numberid/'.$NumberID.'" title="置底"></a>'; } ?>
</div>
</td>
<td align="center">
...
<td align="center"><a href="/lh3/index.php/Home/Links/index_class_add.html?Id=<?php echo ($vo['numberid']); ?>">添加下级目录</a></td>
<td align="center"><a href="/lh3/index.php/Home/Links/index_class.html?Id=<?php echo ($vo['numberid']); ?>">查看下级目录</a></td>
<td align="center">
<a href="/lh3/index.php/Home/Links/index_class_edit.html?Id=<?php echo ($vo['id']); ?>">编辑</a>
</td>
