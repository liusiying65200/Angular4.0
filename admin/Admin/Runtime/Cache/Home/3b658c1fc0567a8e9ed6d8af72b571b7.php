                                    ...
                                    <form id="addForm">
                                        <table class="page_table" cellpadding="0" cellspacing="1">
                                            <tr>
                                                ...
                                                <td width="90%" class="left"><input id="kithe" value='<?php echo ($row["kithe"]); ?>' style="width:350px;" class="biankuan" placeholder="请输入标题名称"/></td>
                                            </tr>

                                            <tr>
                                                <td width="10%" class="td_left">内幕资料：</td>
                                                <td width="90%" class="left">
                                                    <div class="m-b">单双中特：<input  type="text" id="sdms" value="<?php echo ($row["inner_info"]["sdms"]); ?>" class="biankuan" style="width:350px;"/></div>
                                                    <diV class="m-b">野兽家畜：<input  type="text" id="wild" value="<?php echo ($row["inner_info"]["wild"]); ?>" class="biankuan" style="width:350px;"/></diV>
                                                    <div>精选波色：<input  type="text" id="waveColor" value="<?php echo ($row["inner_info"]["waveColor"]); ?>" class="biankuan" style="width:350px;"/></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="10%" class="td_left">必中生肖：</td>
                                                <td width="90%" class="left">
                                                    <div class="m-b">九肖中特：<input   id="shengxiao_9" value="<?php echo ($row["shengxiao"]["shengxiao_9"]); ?>" class="biankuan" style="width:350px;"/></div>
                                                    <diV class="m-b">七肖中特：<input   id="shengxiao_7" value="<?php echo ($row["shengxiao"]["shengxiao_7"]); ?>" class="biankuan" style="width:350px;"/></diV>
                                                    <div class="m-b">六肖中特：<input id="shengxiao_6" value="<?php echo ($row["shengxiao"]["shengxiao_6"]); ?>" class="biankuan" style="width:350px;"/></div>
                                                    <div>四肖中特：<input  id="shengxiao_4" value="<?php echo ($row["shengxiao"]["shengxiao_4"]); ?>" class="biankuan" style="width:350px;"/></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="10%" class="td_left">必中生肖：</td>
                                                <td width="90%" class="left">
                                                    <div class="m-b">杀一肖：<input  type="text" id="sha_1" value="<?php echo ($row["shaxiao"]["sha_1"]); ?>" class="biankuan" style="width:350px;"/></div>
                                                    <diV>杀一尾：<input  type="text" id="sha_last" value="<?php echo ($row["shaxiao"]["sha_last"]); ?>" class="biankuan" style="width:350px;"/></diV>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td align="left">
                                                    <input type="button"  value="提交内容" class="tijiao_input"  onClick="edit(<?php echo ($row["id"]); ?>)"/>
                                                </td>
                                            </tr>
                                        </table>
                                    </form>
...
<![endif]-->
    ...
    <script>
        ...
        function edit(id){
            ...
            $.ajax({
                url: "/lhc2/admin/index.php/Home/Article/innerInfo_edit",
                dataType:"json",
                type:"POST",
                data:{id:id,kithe:$('#kithe').val(),shengxiao:shengxiao,inner_info:inner_info,shaxiao:shaxiao},
