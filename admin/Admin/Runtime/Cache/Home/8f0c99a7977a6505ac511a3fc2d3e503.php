...
<input type="button" value="添加图库期数" onclick="location.href='/lh3/index.php/Home/Tuku/qs_info_add.html'"  class="btn btn-xs btn-danger" />
...
<form class="form-search form-horizontal" action="/lh3/index.php/Home/Tuku/" method="get">
							...
							<div class="col-xs-12 col-sm-3 btn-sespan">
							  ...
							  <div class="input-group-btn">
								<a href="/lh3/index.php/Home/Tuku/qs.html">
...
<td align="center"><?php echo (czdirectory('qs','0',$vo["directory4"])); ?> </td>
<td align="center"><?php echo (datetime($vo["begtime"])); ?> </td>
<td align="center">
<a href="/lh3/index.php/Home/Tuku/qs_info_edit/Id/<?php echo ($vo["id"]); ?>">修改</a> 
...
$("#msg").html(data.msg)
intervalid =setInterval("TiaoSecond('/lh3/index.php/Home/Tuku/qs.html')",1000);//==========执行几秒跳转
}
});
}
...
jQuery.ajax({
url: "/lh3/index.php/Home/Tuku/qs_infodelete.html",
dataType:"json",
type:"POST",
