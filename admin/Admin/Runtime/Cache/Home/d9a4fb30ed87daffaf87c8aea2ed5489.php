    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="row maintop">
                    <div class="col-xs-12 col-sm-8">
                        ...
                        <form >
                            ...
                            <input type="button" value="添加文章" onclick="location.href='/lhc2/admin/index.php/Home/Article/manage_add'"  class="btn btn-xs btn-danger" />
                ...
                <form class="form-search form-horizontal" action="/lhc2/admin/index.php/Home/Article/manage" method="get">
                    <div class="row maintop">
                        ...
                        <div class="input-group-btn">
                            <a href="/lhc2/admin/index.php/Home/Article/manage">
                                    ...
                                    <div class="table-responsive">
                                        <table width="100%" class="table table-striped table-bordered table-hover">
                                            ...
                                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr bgcolor="ffffff" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#F5F5F5'">
                                                    ...
                                                    <td align="center"><?php echo ($vo["smalltitle"]); ?></td>
                                                    <td align="center"><?php echo ($vo["fname"]); ?></td>
                                                    <td align="center"><?php echo ($vo["picurl"]); ?></td>
                                                    <td align="center"><?php echo ($vo["author"]); ?></td>
                                                    <td align="center"><?php echo ($vo["hits"]); ?></td>
                                                    <td align="center">
                                                        <a href="/lhc2/admin/index.php/Home/Article/manage_edit?id=<?php echo ($vo["id"]); ?>">修改</a>
...
<script>
    ...
    function del(){
        ...
        if(confirm('您确定要删除此数据？')){
            ...
            ids=dropIds.join(',');
            $.ajax({
                url: "/lhc2/admin/index.php/Home/Article/manage_del",
                dataType:"json",
                type:"POST",
                data:{id:ids},
