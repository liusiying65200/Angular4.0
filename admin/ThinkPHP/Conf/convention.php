...
return  array(
	...
	'Article/:id\d'=>'Article/detail', //规则路由
	'Bbs/:id\d'=>'Bbs/detail', //规则路由
	'Article/lists/:id\d'=>'Article/lists', //规则路由
	'Tuku/:id\d'=>'Tuku/detail', //规则路由
	'Heibai/:id\d'=>'Heibai/detail', //规则路由
	'Pic/:id\d'=>'Pic/detail', //规则路由
	'article_detail/:id\d'=>'Wap/article_detail', //规则路由
	), // 默认路由规则 针对模块
